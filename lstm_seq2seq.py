...
# print(encoder_input_data[0][0][:30])
# print(encoder_input_data[:1,:2:30])
...
plot_model(model, to_file='encoder-decoder_model_plot.png', show_shapes=True, show_layer_names=True)
print(model.summary())
...
# model.save('s2s_copy2.h5')

model.load_weights('s2s_copy2.h5')
